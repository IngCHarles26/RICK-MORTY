...
function AboutContact() {
  return ( 
    <div className="aboutContact">
      <a className="social-link1" href='https://github.com/IngCHarles26' target='_blank'>
      ...
      <a className="social-link2" href='https://www.linkedin.com/in/carlos-rodrigo-condori-llerena-090864178/' target='_blank'>
